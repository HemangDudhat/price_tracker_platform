...
export async function sendPriceDropAlert(
  ...
  try {
    ...
    const sentFrom = new Sender(
      process.env.MAILERSEND_FROM_EMAIL, // must be verified domain
      "Price Tracker"
    );
    ...
    const emailParams = new EmailParams()
      .setFrom(sentFrom)
      .setTo(recipients)
      .setSubject(`🎉 Price Drop Alert: ${product.name}`)
      .setHtml(`
<!DOCTYPE html>
<html>
<head>
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background: #ffffff; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 10px 10px;">
    ...
    <div style="text-align: center; margin: 30px 0;">
      <a href="${product.url}"
         style="background: #FA5D19; color: white; padding: 14px 30px; text-decoration: none; border-radius: 6px;">
        View Product →
      </a>
    </div>

    <div style="border-top: 1px solid #e5e7eb; padding-top: 20px; text-align: center; font-size: 12px;">
      <p>You’re receiving this email because you track this product.</p>
      <a href="${process.env.NEXT_PUBLIC_APP_URL}" style="color: #FA5D19;">
